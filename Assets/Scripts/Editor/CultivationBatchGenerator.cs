...
namespace CardGame.Editor
{
    public static class CultivationBatchGenerator
    {
        ...
        private static int CreateSanYang()
        {
            ...
            {
                // ── 练气期 (人火之境) ──
                Node("sy_lq_1", "化伤术", "修炼基础治疗术，可治愈伤势。", RealmLevel.LianQi,
                    unlockType: NodeUnlockType.Comprehension, cost: 5,
                    reward: NodeRewardType.DivineAbility, rewardIds: new List<string>{"da_huashang"},
                    pos: new Vector2(0, 0)),
                Node("sy_lq_2", "驱云诀", "驱散云雾，基础御气之法。", RealmLevel.LianQi,
                    prereq: "sy_lq_1", unlockType: NodeUnlockType.Comprehension, cost: 5,
                    reward: NodeRewardType.DivineAbility, rewardIds: new List<string>{"da_quyun"},
                    pos: new Vector2(0, 1)),
                ...
                Node("sy_jd_2a", "壹·五内蕴火", "五脏蕴火，提升全五维。", RealmLevel.JinDan,
                    prereq: "sy_jd_1", unlockType: NodeUnlockType.MutualExclusion, mutex: "sy_jd_branch",
                ...
                Node("sy_jd_3", "御真秘典", "参悟御真之法，提升术法威力。", RealmLevel.JinDan,
                    ...
                    reward: NodeRewardType.PassiveStat, passive: PassiveStatType.Strength, passiveVal: 1,
                    pos: new Vector2(2, 4)),
                ...
                Node("sy_jd_5", "净火灼心", "以净火炼心，提升悟性。", RealmLevel.JinDan,
                    ...
                    reward: NodeRewardType.PassiveStat, passive: PassiveStatType.DrawCount, passiveVal: 1,
                    pos: new Vector2(2, 6)),

                // ── 元婴期 (天火之境) ──
                Node("sy_yy_1", "入定之术", "修炼入定之法。", RealmLevel.YuanYing,
                    prereq: "sy_jd_5", unlockType: NodeUnlockType.Comprehension, cost: 30,
                    reward: NodeRewardType.DivineAbility, rewardIds: new List<string>{"da_ruding"},
                    pos: new Vector2(3, 0)),
                Node("sy_yy_2", "灵息诀", "调息之法，提升灵气上限。", RealmLevel.YuanYing,
                    prereq: "sy_yy_1", unlockType: NodeUnlockType.Comprehension, cost: 25,
                    reward: NodeRewardType.DivineAbility, rewardIds: new List<string>{"da_lingxi"},
                    pos: new Vector2(3, 1)),
                Node("sy_yy_3", "玄牝重生法", "重生秘法。", RealmLevel.YuanYing,
                    prereq: "sy_yy_2", unlockType: NodeUnlockType.Comprehension, cost: 30,
                    reward: NodeRewardType.DivineAbility, rewardIds: new List<string>{"da_xuanpi"},
                    pos: new Vector2(3, 2)),
                Node("sy_yy_4a", "壹·始日真诀", "提升术法威力。", RealmLevel.YuanYing,
                    prereq: "sy_yy_3", unlockType: NodeUnlockType.MutualExclusion, mutex: "sy_yy_branch1",
                    reward: NodeRewardType.PassiveStat, passive: PassiveStatType.Strength, passiveVal: 2,
                    pos: new Vector2(3, 3)),
                Node("sy_yy_4b", "贰·焚日真法", "更强的术法威力提升。", RealmLevel.YuanYing,
                    prereq: "sy_yy_3", unlockType: NodeUnlockType.MutualExclusion, mutex: "sy_yy_branch1",
                    reward: NodeRewardType.PassiveStat, passive: PassiveStatType.Strength, passiveVal: 3,
                    pos: new Vector2(3, 4)),
                ...
                Node("sy_hs_1a", "壹·焚风术", "焚烧罡风，攻击术法。", RealmLevel.HuaShen,
                    prereq: "sy_yy_5", unlockType: NodeUnlockType.MutualExclusion, mutex: "sy_hs_branch1",
                ...
                Node("sy_hs_4a", "壹·心火", "降低术法灵气消耗。", RealmLevel.HuaShen,
                    prereq: "sy_hs_3", unlockType: NodeUnlockType.MutualExclusion, mutex: "sy_hs_branch2",
                    reward: NodeRewardType.PassiveStat, passive: PassiveStatType.MaxMana, passiveVal: 1,
                    pos: new Vector2(4, 4)),
                ...
                Node("sy_hs_5a", "壹·真火炼身", "提升法术威力。", RealmLevel.HuaShen,
                    prereq: "sy_hs_4a", unlockType: NodeUnlockType.MutualExclusion, mutex: "sy_hs_branch3",
                    reward: NodeRewardType.PassiveStat, passive: PassiveStatType.Strength, passiveVal: 2,
                    pos: new Vector2(4, 6)),
                ...
                Node("sy_hs_7a", "壹·天火同人", "提升机缘。", RealmLevel.HuaShen,
                    prereq: "sy_hs_6", unlockType: NodeUnlockType.MutualExclusion, mutex: "sy_hs_branch4",
                    reward: NodeRewardType.PassiveStat, passive: PassiveStatType.ShenShi, passiveVal: 3,
                    pos: new Vector2(4, 9)),
        ...
        private static int CreateTaiHe()
        {
            ...
            {
                // ── 练气期 (凝气期) ──
                Node("th_lq_1", "封灵术", "制作灵契，封印之术。", RealmLevel.LianQi,
                    unlockType: NodeUnlockType.Comprehension, cost: 5,
                    reward: NodeRewardType.DivineAbility, rewardIds: new List<string>{"da_huashang"},
                    pos: new Vector2(0, 0)),
                ...
                Node("th_jd_6a", "壹·御木诀", "以阳寿施肥。", RealmLevel.JinDan,
                    prereq: "th_jd_5", unlockType: NodeUnlockType.MutualExclusion, mutex: "th_jd_branch1",
                ...
                Node("th_jd_7a", "壹·天伤化水", "恢复友方灵气。", RealmLevel.JinDan,
                    prereq: "th_jd_6a", unlockType: NodeUnlockType.MutualExclusion, mutex: "th_jd_branch2",
                    reward: NodeRewardType.PassiveStat, passive: PassiveStatType.MaxMana, passiveVal: 1,
                    pos: new Vector2(2, 7)),
                ...
                Node("th_yy_1a", "壹·入定之术", "修炼入定之法。", RealmLevel.YuanYing,
                    prereq: "th_jd_8", unlockType: NodeUnlockType.MutualExclusion, mutex: "th_yy_branch1",
                    reward: NodeRewardType.DivineAbility, rewardIds: new List<string>{"da_ruding"},
                    pos: new Vector2(3, 0)),
                ...
                Node("th_yy_4a", "壹·乘风诀", "乘风之术。", RealmLevel.YuanYing,
                    prereq: "th_yy_3", unlockType: NodeUnlockType.MutualExclusion, mutex: "th_yy_branch2",
                    reward: NodeRewardType.PassiveStat, passive: PassiveStatType.ShenShi, passiveVal: 3,
                    pos: new Vector2(3, 4)),
                ...
                Node("th_yy_5a", "壹·奔流诀", "奔流之术。", RealmLevel.YuanYing,
                    prereq: "th_yy_4a", unlockType: NodeUnlockType.MutualExclusion, mutex: "th_yy_branch3",
                    reward: NodeRewardType.PassiveStat, passive: PassiveStatType.Strength, passiveVal: 2,
                    pos: new Vector2(3, 6)),
                ...
                Node("th_yy_6a", "水精真形", "提升根骨。", RealmLevel.YuanYing,
                    prereq: "th_yy_5a", unlockType: NodeUnlockType.MutualExclusion, mutex: "th_yy_triple",
                    reward: NodeRewardType.PassiveStat, passive: PassiveStatType.ShenShi, passiveVal: 5,
                    pos: new Vector2(3, 8)),
                ...
                Node("th_hs_1a", "壹·暴雨术", "召唤暴雨。", RealmLevel.HuaShen,
                    prereq: "th_yy_6a", unlockType: NodeUnlockType.MutualExclusion, mutex: "th_hs_branch1",
                ...
                Node("th_hs_3a", "壹·罡煞合流", "罡煞合一。", RealmLevel.HuaShen,
                    prereq: "th_hs_2", unlockType: NodeUnlockType.MutualExclusion, mutex: "th_hs_branch2",
                    reward: NodeRewardType.PassiveStat, passive: PassiveStatType.Strength, passiveVal: 2,
                    pos: new Vector2(4, 3)),
                ...
                Node("th_hs_3c", "叁·罡煞合流", "最深层次罡煞合一。", RealmLevel.HuaShen,
                    prereq: "th_hs_2", unlockType: NodeUnlockType.MutualExclusion, mutex: "th_hs_branch2",
                    reward: NodeRewardType.PassiveStat, passive: PassiveStatType.Strength, passiveVal: 4,
                    pos: new Vector2(4, 5)),
        ...
        private static CultivationNodeData Node(string id, string name, string desc, RealmLevel realm,
            ...
            NodeRewardType reward = NodeRewardType.None, List<string> rewardIds = null,
